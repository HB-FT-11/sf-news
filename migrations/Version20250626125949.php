 ...
 */
final class Version20250626125949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO category(name) VALUES (\'Catégorie par défaut\')'); // ID : 1

        $this->addSql(<<<'SQL'
            ALTER TABLE article ADD category_id INT NOT NULL
        SQL);

        $this->addSql("UPDATE article SET category_id = 1");
